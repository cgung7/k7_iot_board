...
/**
    ApiMappingPattern
    -----------------------------------------
    - 실부 RESTful API URL 패턴을 한 곳에 관리하는 상수 클래스
    - 도메인 단위 그룹 구성
    - 확장성 / 유지보수성 / 일관성 강화
...
public class ApiMappingPattern {
    ...
    public static final class Users {
        ...
        public static final class Boards {
            ...
            //      > 첫 페이지에 10개의 게시물을 최신순(작성순+내림차순) 조회
            ...
            public static final String UN_PIN = BY_ID + "/unpin";

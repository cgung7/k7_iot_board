...
CREATE TABLE users (
    ...
    password VARCHAR(255) NOT NULL COMMENT 'Bcryot 암호화 비밀번호',
...
CREATE TABLE roles (
    ...
    CONSTRAINT `chk_role_role_name` CHECK(role_name IN ('ROLE_USER', 'ROLE_ADMIN', 'ROLE_MANAGER'))
)
	ENGINE=InnoDB
    DEFAULT CHARSET = utf8mb4
    COLLATE = utf8mb4_unicode_ci
...
CREATE TABLE refresh_tokens (
    ...
    expirty DATETIME(6) NOT NULL COMMENT '만료 시간',
...
CREATE TABLE boards(
    ...
    CONSTRAINT `fk_board_category` FOREIGN KEY (category_id) REFERENCES board_category(id)
)    
    ENGINE=InnoDB
    DEFAULT CHARSET = utf8mb4
    COLLATE = utf8mb4_unicode_ci
